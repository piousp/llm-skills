...
A skill is a folder: `SKILL.md` (required) + optional `scripts/`, `references/`, `assets/`, `stages/`, `evals/`.
...
- Never loaded during normal use: `evals/` holds the skill's own evaluation/test suite.
