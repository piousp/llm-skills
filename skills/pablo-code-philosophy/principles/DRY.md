...
- **YAGNI** → See [YAGNI.md](YAGNI.md). Covered by the `DRY vs YAGNI` row in [references/interactions.md](../references/interactions.md), which points back here for the threshold.
- **SOLID** → See [SOLID.md](SOLID.md). Covered by the `DRY vs SRP` row in the conflict matrix, [SKILL.md](../SKILL.md).
- **GoF** → See [GoF.md](GoF.md). Covered by the `GoF vs DRY` row in [references/interactions.md](../references/interactions.md).
- **FP** → See [FP.md](FP.md). Covered by the `FP vs DRY` row in [references/interactions.md](../references/interactions.md), which points back here for the threshold.
- **UNIX** → See [UNX.md](UNX.md). Covered by the `DRY vs UNIX` row in [references/interactions.md](../references/interactions.md).
